...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.LikeMsg = channel.unary_unary(
                '/greet.Greeter/LikeMsg',
                request_serializer=greet__pb2.HelloRequest.SerializeToString,
                response_deserializer=greet__pb2.LikeReply.FromString,
                )
...
class GreeterServicer(object):
    ...
    def LikeMsg(self, request, context):
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'LikeMsg': grpc.unary_unary_rpc_method_handler(
                    servicer.LikeMsg,
                    request_deserializer=greet__pb2.HelloRequest.FromString,
                    response_serializer=greet__pb2.LikeReply.SerializeToString,
            ),
    }
...
class Greeter(object):
    ...
    def LikeMsg(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/greet.Greeter/LikeMsg',
            greet__pb2.HelloRequest.SerializeToString,
            greet__pb2.LikeReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
